            ...
            <div>
                ...
                <form>
                    <div class="mb-3">
                        ...
                        <input type="text" id="website-admin" class="rounded-lg bg-gray-50 text-gray-900 focus:border-none block flex-1 min-w-0 w-full text-sm p-2.5  dark:bg-gray-700" placeholder="Name">
                    </div>

                    <div class="mb-3">
                        <label for="website-admin" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Username</label>
                        <input type="text" id="website-admin" class="rounded-lg bg-gray-50 text-gray-900 focus:border-none block flex-1 min-w-0 w-full text-sm p-2.5  dark:bg-gray-700" placeholder="Email">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="website-admin" class="rounded-lg bg-gray-50 text-gray-900 focus:border-none block flex-1 min-w-0 w-full text-sm p-2.5  dark:bg-gray-700" placeholder="Password">
                    </div>

                    <div class="mb-5">
                        <label for="website-admin" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Confirm Password</label>
                        <input type="text" id="website-admin" class="rounded-lg bg-gray-50 text-gray-900 focus:border-none block flex-1 min-w-0 w-full text-sm p-2.5  dark:bg-gray-700" placeholder="Confirm Password">
                    </div>
